...
class CoffeeGrindSizeGUI:
    ...
    def __init__(self, root):
        ...
        # Remember the root object for the full user interface so
        # that the methods of coffeegrindsize_GUI can refer to it
        self.master = root
        ...
        # Comment on March 3, 2019:
        # To add support for simplified output, use argument simple_data_entry=simple_data_entry
        (self.pixel_length_var,
         self.pixel_length_id,
         self.simple_pixel_length_id) = self.label_entry(def_pix_len,
        ...
        # Roundess is defined between 0 and 1 where 1 is a perfect circle.
        # It represents the fraction of thresholded pixels inside the smallest circle
        # that encompasses the farthest thresholded pixels in one cluster
        self.min_roundness_var = self.label_entry(def_min_roundness, "Minimum Roundness:", "", advanced=True,
                                                  clear_on_click=True)
        
        # Threshold to select pixels dark enough to serve as a reference
        # in the cost function in the cluster breakup step
        ...
        #                     "Available mass vs Surface", "Available mass vs Volume", "Extracted mass vs Diameter",
        #                     "Extracted mass vs Surface", "Extracted mass vs Volume", "Surface vs Diameter",
        #                     "Surface vs Surface", "Surface vs Volume", "Extraction Yield Distribution"]
        # self.hist_codes = ["num_diam", "num_surf", "num_vol", "mass_diam", "mass_surf", "mass_vol", "att_mass_diam",
        #                   "att_mass_surf", "att_mass_vol", "ex_mass_diam", "ex_mass_surf", "ex_mass_vol", "surf_diam",
        #                   "surf_surf", "surf_vol", "ey_dist"]
